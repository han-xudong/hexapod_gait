...
for i=1:5
    ...
    for k=1:50
        ...
        clearpoints(p1)
        addpoints(h,x,y+k/6);
        addpoints(l1,lx1,ly1+[k/6 k]);
        addpoints(l2,lx2,ly2+[k/6 0]);
        addpoints(l3,lx3,ly3+[k/6 0]);
        addpoints(l4,lx4,ly4+[k/6 0]);
        addpoints(l5,lx5,ly5+[k/6 0]);
        addpoints(l6,lx6,ly6+[k/6 0]);
    ...
    for k=1:50
        ...
        clearpoints(p2)
        addpoints(h,x,y+k/6);
        addpoints(l1,lx1,ly1+[k/6 0]);
        addpoints(l2,lx2,ly2+[k/6 k]);
        addpoints(l3,lx3,ly3+[k/6 0]);
        addpoints(l4,lx4,ly4+[k/6 0]);
        addpoints(l5,lx5,ly5+[k/6 0]);
        addpoints(l6,lx6,ly6+[k/6 0]);
